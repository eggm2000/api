...
import {getPedidos_detalle, getPedidos_detallexid, postPedidod_detalle, putPedidos_detalle, patchPedidos_detalle, deletePedidos_detalle} from '../controladores/pedidos_detalle.Ctrl.js'
const router=Router()
// armar nuestras rutas

router.get('/pedidos_detalle', getPedidos_detalle) //select
router.get('/pedidos_detalle/:id', getPedidos_detallexid) //select x id
router.post('/pedidos_detalle', postPedidod_detalle) //insert
